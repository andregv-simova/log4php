 ...
 *
 * @see http://logging.apache.org/log4php/docs/appenders/file.html Appender documentation
 *
...
class LoggerAppenderFile extends LoggerAppender
{
     ...
     *
     * @param null|string $string data to write
     */
    ...
    protected function writeWithLocking(mixed $string)
    {
        ...
        if (flock($this->fp, LOCK_EX)) {
            if (false === fwrite($this->fp, $string)) {
    ...
    protected function writeWithoutLocking(mixed $string)
    {
        if (false === is_string($string)) {
            return;
        }
